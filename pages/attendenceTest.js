import React, { Component } from "C:/Users/USER/AppData/Local/Microsoft/TypeScript/2.9/node_modules/@types/react";
...
var radio_props = [{ label: "A", value: 0 }, { label: "P", value: 1 }];
...
export default class attendancetest extends Component {
  ...
  fetchData = async () => {
    const response = await fetch("http://192.168.1.139:8082/students/all");
